...
exports.cli = function(args) {
    ...
    if (job_modified) {
        ...
        if (path.extname(job_path) === '.coffee') {
            exit('For now, you can only run .coffee files from the command line with no options or args. Compile the file first to get around this limitation');
        }
        
        var temp_filename = 'temp_' + path.basename(job_path, '.js') + '.js';
