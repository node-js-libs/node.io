...
Job.prototype.write = function(file, data, callback) {
    ...
    if (typeof this.output_streams[file] === 'undefined') {
        this.output_streams[file] = fs.createWriteStream(file,{flags:'w',mode:0666,encoding:this.options.encoding});
...
Job.prototype.append = function(file, data, callback) {
    if (typeof this.output_streams[file] === 'undefined') {
        this.output_streams[file] = fs.createWriteStream(file,{flags:'a',mode:0666,encoding:this.options.encoding});
